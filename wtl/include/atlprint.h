...
{
public:
    typedef CPrintPreviewWindowImpl WindowClass;
...
{
public:
    typedef CPrintPreviewWindowImpl< T, TBase, TWinTraits > BaseClassA;
    typedef CZoomScrollImpl< T > BaseClassB;
    using BaseClassB::m_nZoomMode;
    using BaseClassB::m_fZoomScaleMin;
    using BaseClassB::m_fZoomScale;
    using BaseClassB::m_ptOffset;
    using BaseClassB::m_sizeAll;
    using BaseClassA::m_meta;
    using BaseClassA::m_sizeCurPhysOffset;
    using BaseClassA::GetClientRect;
