...
{
public:
    typedef CScrollImpl< T > BaseClass;
    using BaseClass::m_ptOffset;
    using BaseClass::m_sizeAll;
...
{
public:
    typedef CFlatScrollBarImpl<CFSBWindowT< TBase > > BaseClass;
    using TBase::m_hWnd;
    using BaseClass::FlatSB_SetScrollPos;
    using BaseClass::FlatSB_GetScrollInfo;
    using BaseClass::FlatSB_SetScrollInfo;
...
{
public:
    typedef CScrollContainerImpl WindowClass;
    typedef CScrollWindowImpl< T, TBase, TWinTraits > BaseClass;
